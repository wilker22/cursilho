...
<head>
    ...
    <!-- App favicon -->
    <link rel="shortcut icon" href="{{ asset('backend/asset/images/favicon.ico') }}">

    <!-- jquery.vectormap css -->
    <link href="{{ asset('backend/asset/libs/admin-resources/jquery.vectormap/jquery-jvectormap-1.2.2.css') }}"
    ...
    <!-- Bootstrap Css -->
    <link href="{{ asset('backend/asset/css/bootstrap.min.css') }}" id="bootstrap-style" rel="stylesheet"
        type="text/css" />
    <!-- Icons Css -->
    <link href="{{ asset('backend/asset/css/icons.min.css') }}" rel="stylesheet" type="text/css" />
    <!-- App Css-->
    <link href="{{ asset('backend/asset/css/app.min.css') }}" id="app-style" rel="stylesheet" type="text/css" />
    <!--toaster-->
...
<body data-topbar="dark">
    ...
    <!-- JAVASCRIPT -->
    <script src="{{ asset('backend/asset/libs/jquery/jquery.min.js') }}"></script>
    <script src="{{ asset('backend/asset/libs/bootstrap/js/bootstrap.bundle.min.js') }}"></script>
    <script src="{{ asset('backend/asset/libs/metismenu/metisMenu.min.js') }}"></script>
    <script src="{{ asset('backend/asset/libs/simplebar/simplebar.min.js') }}"></script>
    <script src="{{ asset('backend/asset/libs/node-waves/waves.min.js') }}"></script>

    <!-- apexcharts -->
    <script src="{{ asset('backend/asset/libs/apexcharts/apexcharts.min.js') }}"></script>

    <!-- jquery.vectormap map -->
    <script src="{{ asset('backend/asset/libs/admin-resources/jquery.vectormap/jquery-jvectormap-1.2.2.min.js') }}">
    </script>
    <script src="{{ asset('backend/asset/libs/admin-resources/jquery.vectormap/maps/jquery-jvectormap-us-merc-en.js') }}">
    </script>
